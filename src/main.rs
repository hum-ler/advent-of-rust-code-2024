...
fn main() -> Result<()> {
    ...
    match (args.day_number, args.run_code) {
        ...
        (18, RunCode::P2) => println!("{:?}", day_18::run_part_2()),
        (19, RunCode::E1) => println!("{:?}", day_19::run_example_1()),
        (19, RunCode::E2) => println!("No solution"),
        (19, RunCode::P1) => println!("No solution"),
        (19, RunCode::P2) => println!("No solution"),
        (20, RunCode::E1) => println!("No example 1"),
        (20, RunCode::E2) => println!("No example 2"),
        (20, RunCode::P1) => println!("{:?}", day_20::run_part_1()),
        (20, RunCode::P2) => println!("{:?}", day_20::run_part_2()),
        (21, RunCode::E1) => println!("{:?}", day_21::run_example_1()),
        (21, RunCode::E2) => println!("No example 2"),
        (21, RunCode::P1) => println!("{:?}", day_21::run_part_1()),
        (21, RunCode::P2) => println!("No solution"),
        (22, RunCode::E1) => println!("{:?}", day_22::run_example_1()),
        (22, RunCode::E2) => println!("{:?}", day_22::run_example_2()),
        (22, RunCode::P1) => println!("{:?}", day_22::run_part_1()),
        (22, RunCode::P2) => println!("{:?}", day_22::run_part_2()),
        (23, RunCode::E1) => println!("{:?}", day_23::run_example_1()),
        (23, RunCode::E2) => println!("{:?}", day_23::run_example_2()),
        (23, RunCode::P1) => println!("{:?}", day_23::run_part_1()),
        (23, RunCode::P2) => println!("{:?}", day_23::run_part_2()),
